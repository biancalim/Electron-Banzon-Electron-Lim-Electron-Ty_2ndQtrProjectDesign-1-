...
public class PlayerCharacter extends Entity {
    ...
    public PlayerCharacter(String n, Role r, String ec, String hc, int cxp, int cl, int xpfnl, int cma, Weapon w, Potion p, Potion op, Section cse, Stage cst, Shop csh) {
        this.setName(n);
        this.setMaxHealth(r.getMaxHealth());
        this.setCurrentHealth(r.getMaxHealth());
        this.setBaseAttack(r.getStartingAttack());
        this.setBaseDefense(r.getStartingDefense());
        this.setRole(r);
        this.eyeColor = ec;
        this.hairColor = hc;
        this.currentXP = cxp;
    ...
    public void useMove(Move move, Enemy enemy) {
        ...
        enemy.setBaseAttack(enemy.getBaseDefense() - move.getDefenseDebuff());
    ...
    public void battleWinnings(Enemy enemy, Move move, Section nextSection) {
        ...
        if ((move.getTimeElapsedSinceLastUse() < move.getLengthOfEffect()) && (move.getTarget().equals("PlayerToPlayer") || move.getTarget().equals("EnemyToPlayer"))) {
            move.resetMove(enemy, this);
        }
    ...
    public void battleLosings(Enemy enemy, Move move) {
